        ...
        <table className={s.table}>
          <thead>
            <tr>
              ...
              {internationalSizes.map((size) => (
                <th key={size} className={s["international-size"]}>
                  {size}
                </th>
              ))}
            </tr>
          ...
          <tbody>
            <tr>
              ...
              {chestSizes.map((size) => (
                <td key={size} className={s.chest_size}>
                  {size}
                </td>
              ))}
            </tr>
            <tr>
              ...
              {waistSizes.map((size) => (
                <td key={size} className={s.waist_size}>
                  {size}
                </td>
              ))}
            </tr>
            <tr>
              ...
              {russianSizes.map((size) => (
                <td key={size} className={s.russian_size}>
                  {size}
                </td>
              ))}
            </tr>
