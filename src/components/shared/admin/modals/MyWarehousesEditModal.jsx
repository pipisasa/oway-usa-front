...
export default function MyWarehousesEditModal({isOpen, onClose, warehouse}) {
    const [trackingNumber, setTrackingNumber] = useState(warehouse?.tracking_number || "");
    ...
    const chooseWarehouses = countries.find(country => country.name === warehouse?.warehouse)
    ...
    const chooseCourier = deliveryServices.find(country => country.name === warehouse?.courier_service)
