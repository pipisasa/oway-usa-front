    ...
    return (
        <div className={`${s.service} container`}>
            <div className={s.service_header}>
                <span>Услуги</span>
                <h1>Предоставляемые нами <br/> услуги</h1>
            </div>
            <div className={s.services_block}>
                ...
                <div className={s.services_block_span}>
                    <div className={s.services_block_span_div}>
                        <div></div>
                        <span>5 качественных фото за 3$  + можно добавить фото бирок или этикеток</span>
                    </div>
                    <div>
                        <img src="assets/images/electronic.png" width={650} height={333} alt=""/>
                    </div>
                </div>
            </div>
            <div className={s.services_block}>
                ...
                <div className={s.services_block_span}>
                    <div  className={s.services_block_span_div}>
                        <div></div>
                        <span>Проверка товаров необходима, чтобы гарантировать соответствие описанию на сайте и целостность при поступлении на склад. Заказ услуги проверки для товаров следует оформить до их поступления, доступна после оплаты заказа.  </span>
                    </div>
                    <div  className={s.services_block_span_div}>
                        <div></div>
            ...
            <div className={s.services_block}>
                ...
                <div className={s.services_block_span}>
                    <div className={s.services_block_span_div}>
                        <div></div>
                        <span>В США есть категория магазинов которые категорически не отправляют на склады по разным причинам. Для этого у нас есть решение и можем выкупить со всех сайтов без ограничений. Для подоброй информации напишите нашему менеджеру</span>
                    </div>
