  ...
  return (
    <div className={`${s.mission} container`}>
      ...
      <div className={s.mission_header}>
        <h1>
          Перевозка коммерческих и частных грузов
          <br />
          из США и Турции в страны СНГ, из СНГ <br />
          в США через авиацию - без весовых,
          <br />
          размерных или категорийных ограничений.
        </h1>
        <div>
          <div className={s.mission_header_info}>
            <div></div>
            <span>
              <strong>Мы предоставляем</strong> полный спектр логистических
              услуг. Для вашего удобства доступны варианты доставки "от двери до
              двери" или до ближайшего ПВЗ, а также возможность забора из нашего
              пункта выдачи в каждой стране. 
            </span>
          </div>
          <div className={s.mission_header_info}>
            <div className={s.mission_header_info_div}></div>
            <span>
              А так же уникальные предложении как « отправка из США сразу в 4
              стран СНГ ( или прям страны расписать, РФ, КР, РК, УЗ ) и потом
              дальше написать что было
            </span>
          </div>
        </div>
      </div>
