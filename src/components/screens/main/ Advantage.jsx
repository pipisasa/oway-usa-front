                ...
                <div className={s.advantage_inner}>
                    ...
                    <div className={s.menu}>
                        ...
                        {props?.menu === 'service' && (
                            <>
                                <div
                                    className={`${s["menu-item"]} ${selectedItem === 4 ? s.active : ""}`}
                                    onClick={() => handleItemClick(4)}
                                >
                                    <img src={service[3]?.icon} alt=""/>
                                    <span>
                                        {props?.menu === "service" && service[3]?.text}
                                     </span>
                                </div>
                                <div
                                    className={`${s["menu-item"]} ${selectedItem === 5 ? s.active : ""}`}
                                    onClick={() => handleItemClick(5)}
                                >
                                    <img src={service[4]?.icon} alt=""/>
                                    <span>
                                        {props?.menu === "service" && service[4]?.text}
                                </span>
                                </div>
                            </>
                        )}
                ...
                <div className={s.info}>
                    {selectedItem === 1 && (
                        <div className={s["info-content"]}>
                            {props?.menu === "service" ?
                                <img src={service[0]?.img} width={825} height={327} alt="logo"/>
                                :
                    ...
                    {selectedItem === 2 && (
                        <div className={s["info-content"]}>
                            {props?.menu === "service" ?
                                <img src={service[1]?.img} width={825} height={327} alt="logo"/>
                                :
