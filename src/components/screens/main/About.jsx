            ...
            <div className={`${s.heroSection_page} container`}>
                <div className={s.heroSection_info}>
                    ...
                    <div className={s.heroSection_info_span}>
                        <div></div>
                        <span><strong>OWAY USA </strong> - логистическая компания осуществеляющая отправки коммерсечких и физических посылок из США и Турции в страны СНГ</span>
                    </div>

                </div>
                <Button button="Закупиться"/>
                <div className={s.heroSection_img1}>
                    <img src="assets/images/teleshkaOrange.png" width={537} height={537} alt=""/>
                </div>
            </div>
        </div>
    );
