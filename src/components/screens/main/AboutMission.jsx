        ...
        <div className={`${s.mission} container`}>
            ...
            <div className={s.mission_header}>
                ...
                <div className={s.mission_header_info}>
                    <div></div>
                    <span> <strong>Наш портфель услуг</strong> включает в себя отзывы клиентов, возможность однокликовой покупки, персонализированные рекомендации, а также такие уникальные предложения, как "Помощь при покупке", "Собственная цепочка логистических путей", "Возможность заказать из СНГ в США", и "Сопровождение бизнеса на территории Турции". Все эти услуги сделали OWAY USA одним из лучших в своей области.</span>
                </div>
            </div>
